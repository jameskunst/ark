...
#define MOTOR_ERR(fmt, args...)    printk(KERN_DEBUG MOTOR_TAG" %s : "fmt,__FUNCTION__,##args)
#define MOTOR_LOG(fmt, args...)    printk(KERN_DEBUG MOTOR_TAG" %s : "fmt,__FUNCTION__,##args)
